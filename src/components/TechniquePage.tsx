...
import { techniques } from '../data/routes';
  ...
  if (!technique) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Technique not found</h1>
      </div>
    );
  }
        ...
        <div className="p-6">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-500">{technique.description}</p>
            </div>
          </div>
